...
export default function PontuacaoEtapa9Screen() {
  ...
  async function loadCurrentMatch() {
    try {
      ...
      setScores(parsedMatch.scores.capturedAgents ?? {});
    } catch {
  ...
  async function saveAndContinue() {
    ...
    try {
      ...
      router.push("/partida/pontuacao/10");
    } catch {
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <ThemedView style={styles.container}>
          <ThemedView style={styles.header}>
            <ThemedText type="title">Agentes capturados</ThemedText>

            <ThemedText style={styles.description}>
              Informe quantos agentes foram capturados pelos agentes de cada
              jogador. Cada agente capturado vale 1 ponto.
            </ThemedText>
          </ThemedView>
