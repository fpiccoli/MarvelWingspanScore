...
export default function PontuacaoEtapa7Screen() {
  ...
  async function loadCurrentMatch() {
    try {
      ...
      setScores(parsedMatch.scores.coinsOnAgents ?? {});
    } catch {
  ...
  async function saveAndContinue() {
    ...
    try {
      ...
      router.push("/partida/pontuacao/8");
    } catch {
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <ThemedView style={styles.container}>
          <ThemedView style={styles.header}>
            <ThemedText type="title">Moedas em agentes</ThemedText>

            <ThemedText style={styles.description}>
              Informe quantas moedas ficaram acumuladas nos agentes de cada
              jogador. Cada moeda vale 1 ponto.
            </ThemedText>
          </ThemedView>
