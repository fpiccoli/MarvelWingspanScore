...
// Rodada 2
const ROUND_INDEX = 1;
const ROUND_POINTS = [5, 2, 1, 0, 0, 0];
...
export default function Etapa3Rodada1Screen() {
  ...
  function goBack() {
    router.push("/partida/pontuacao/3");
  }
  ...
  async function saveAndContinue() {
    ...
    const updated: CurrentMatch = {
      ...
      scores: {
        ...currentMatch.scores,
        roundBonusByRound: (() => {
          const previousRounds = currentMatch.scores.roundBonusByRound ?? [];
          const updatedRounds = [...previousRounds];

          updatedRounds[ROUND_INDEX] = roundScore;
    ...
    router.push("/partida/pontuacao/5");
  }
    ...
    <SafeAreaView style={{ flex: 1 }} edges={["top"]}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <ThemedView style={styles.container}>
          ...
          <ThemedText type="subtitle">Rodada 2</ThemedText>

          {isBest ? (
            <>
              <ThemedText style={styles.rules}>
                1º: 5 pts | 2º: 2 pts | 3º: 1 pt | resto: 0
              </ThemedText>
